...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Lato:wght@300;400;700&family=Mohave:wght@300;400;500&family=Montserrat:wght@300;400;500&family=Nunito:wght@300;400;500&family=Roboto:wght@500&display=swap" rel="stylesheet"> 
    <!-- Styles -->
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="logo d-flex align-items-center" href="{{ url('/') }}">
                    ...
                    <FONT face="Roboto" class=" ml-1">
                        <h1 class="m-0" style="font-size:30px">Boolbnb</h1>
                    </FONT>
                </a>

<template>
  ...
  <div class="row mt-8 m-8 justify-content-center">
    <div class="col-md-5 align-self-center">
      <h1 class="text-jumbo text-ginormous hide-sm">Ops!</h1>
      <h2>Non troviamo la pagina che stai cercando.</h2>
      <h6>Codice errore: 404</h6>
